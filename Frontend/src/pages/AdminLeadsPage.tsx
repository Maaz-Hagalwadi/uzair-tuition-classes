      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mb-5">
          ...
          <input
            ...
            className="w-full max-w-sm pl-10 pr-4 py-2.5 bg-white border border-[#c8c5d0] rounded-lg text-sm text-[#131b2e] placeholder-[#787680] focus:outline-none focus:border-[#070235] focus:ring-2 focus:ring-[#070235]/10 transition-all"
          />
        </div>
        ...
        <div className="bg-white border border-[#c8c5d0] rounded-xl overflow-hidden">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              <span
                className="material-symbols-outlined text-[48px] text-[#c8c5d0] mb-3"
                ...
                {filtered.map((lead) => (
                  <tr key={lead.id} className="hover:bg-[#faf8ff] transition-colors">
                    ...
                    <td className="px-5 py-4 max-w-[200px]">
                      {lead.message ? (
                        <p className="text-[#505f76] truncate text-xs" title={lead.message}>
                          {lead.message}
                        </p>
                      ) : (
